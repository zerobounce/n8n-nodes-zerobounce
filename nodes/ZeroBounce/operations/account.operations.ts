	...
	// eslint-disable-next-line n8n-nodes-base/node-param-default-missing
	{
		...
		options: [
			...
			},
			{
				...
				name: 'List Filters',
				action: 'List existing allowlist and blocklist filters',
				description: 'Lists all the existing allow/block filter rules',
			},
			{
				value: Operations.AccountAddFilter,
				name: 'Add Filter',
				action: 'Add an allowlist or blocklist filter',
				description: 'Adds or updates an allow/block filter rule',
			},
			{
				value: Operations.AccountDeleteFilter,
				name: 'Delete Filter',
				action: 'Delete an allowlist or blocklist filter',
				description: 'Deletes an allow/block filter rule',
			},
		],

...
const SendFileFields: INodeProperties[] = [
	...
	resource: [Resources.BulkScoring],
...
export const BulkScoringOperations: INodeProperties[] = [
...
// prettier-ignore
export const BulkScoringOperationHints: NodeHint[] = [
